...
func GetAllProducts(c *fiber.Ctx) error {
	...
	products, page, err := service.GetAllProducts(c, params)
	if err != nil {
...
func CreateProduct(c *fiber.Ctx) error {
	input := entity.ProductRequest{}
	if err := c.BodyParser(&input); err != nil {
		return utils.NewErrors(err, nil, nil).GetErrorResponse(c)
	}

	product, err := service.CreateProduct(c, input)
	if err != nil {
		return err.GetErrorResponse(c)
	}
...
func GetProduct(c *fiber.Ctx) error {
	...
	product, err := service.GetProduct(c, id)
	if err != nil {
		return err.GetErrorResponse(c)
	}
...
func DeleteProduct(c *fiber.Ctx) error {
	...
	if err := service.DeleteProduct(c, id); err != nil {
		return err.GetErrorResponse(c)
	}
